...
?>
<h3 style="text-align:center">Tank Chip Details</h3>
...
$qry=mysqli_query($dbcon,"SELECT tch.*,vl.hallmark AS vlmark FROM tank_chip_handover tch LEFT JOIN vehicle_list vl ON tch.hallmark=vl.id WHERE tch.cid='$cid' AND tch.eid='$eid'");
if($qry){
...
<div style="margin-left:25px;">
<?php
$qry1=mysqli_query($dbcon,"SELECT tch.*,vl.hallmark AS vlmark FROM tank_chip_return tch LEFT JOIN vehicle_list vl ON tch.hallmark=vl.id WHERE tch.cid='$cid' AND tch.eid='$eid'");
if($qry1){
