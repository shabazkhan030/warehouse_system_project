<meta charset="utf-8">
<style>.print-w100 {width: 100%;display: flex;}</style>

<div class="print-w100">
<div class="w-50 p-20">
	<div class="d-flex mb-20">
		<a href="#" class="d-inline-block p-5 cur-pointer text-light text-decoration ml-10 bg-orange">Protokol Ausgabe </a>
	...
	<div id="printtankchipcreate" class="border-2 w-100">
		<div style="text-align:center;padding-top:30px;">
			<h2 id="headingText">&Uuml;bergabeprotokoll Tankchip</h2>
	    ...
	    <div style="display:flex;justify-content: space-between;margin-top:20px;">
			<div style="margin:25px;width:50%">
				...
				<p style="margin-bottom:0.5rem"><span id="empl_phone"></span></p>
				<p style="margin-bottom:0.5rem"><span id="empl_dob"></span></p>
			</div>
			<div style="margin:25px;width:50%">
		...
		<div class="ml-20 mt-10 mr-10" style="margin-left:25px;">
			<label style="font-size:18px;font-weight:bold;">Datum</label><br>
...
<div class="w-50 p-20">
	<div class="d-flex mb-20">
		<a href="javascript:void(0)" class="d-inline-block p-5 cur-pointer text-light text-decoration ml-10 bg-orange">R&uuml;ckgabe Protokol</a>
	...
	<div id="printtankchipreturn" class="border-2 w-100">
		<div style="text-align:center;padding-top:30px;">
			<h2 id="headingTextReturn">R&uuml;ckgabe Protokol Tankchip</h2>
		    <input type="hidden" id="textReturn">
		    <input type="hidden" id="prid">	
		</div>
          <div style="display:flex;justify-content: space-between;margin-top:20px;">
			<div style="margin:25px;width:50%">
    			<p style="font-size:16px;margin-bottom:0.5rem"><b>xMitarbeiter</b></p>
    			...
    			<!--<p style="font-size:16px;margin-bottom:0.5rem">PLZ:</p>-->
    			 
    			<br>
    			<br>
    			<p style="margin-bottom:0.5rem"><span id="rempl_phone"></span></p>
    			<p style="margin-bottom:0.5rem"><span id="rempl_dob"></span></p>

    		</div>
    		<div style="margin:25px;width:50%">
    			<!--<p style="font-size:16px;"><b>Company</b></p>-->
    			...
    			<!--<p style="font-size:16px;">Post code:<span id="rcom_zip"></span></p>-->
    		</div>
          </div>
        <div style="margin:25px">
			<div style="display:flex;">
